...
\begin{enumerate}
	...
	\begin{itemize}
		\item Solución aplicada: Se decidió qué color y tonalidad iba a tener cada categoría encontrada, y se aplicó el color definido para cada caso de forma uniforme.
	\end{itemize}
	\item Introducción manual de datos. Se encontraron valores escritos directamente en las celdas, en lugar de seleccionarse mediante el validador de datos.
	\begin{itemize}
		\item Solución aplicada: Se analizó y detectó qué datos habían sido introducidos de manera manual, se añadió su valor a la lista del validador, y se eligió mediante este.
	\end{itemize}
...
Se ha adjuntado la imagen~\ref{fig:problemas-unificaciones}, en la que se observan varios de los problemas que acaban de ser expuestos.

\imagen{img/InconsistenciasExcel.png}{Imagen descriptiva de los problemas de uniformidad de la hoja de cálculo de horarios}{fig:problemas-unificaciones}
...
En la imagen~\ref{fig:problemas-colores}, se aprecian cómo había diferentes tonos de azul asignados para las clases prácticas del mismo grupo, en este caso, el grupo~1.

\imagen{img/ColoresClasesExcel.png}{Imagen descriptiva de los diferentes tonos de color asignados a un mismo tipo de clase y grupo}{fig:problemas-colores}


Y por último, se adjuntan las imágenes~\ref{fig:problemas-estructuras-1}, ~\ref{fig:problemas-estructuras-2} y~\ref{fig:problemas-estructuras-3}, en las que se van a poder ver las diferentes estructuras que se han tenido que tener en cuenta para poder extraer de manera correcta la información de las clases.

\imagen{img/EstructurasClases.png}{Imagen con dos tipos de estructuras para los grupos teóricos y los prácticos}{fig:problemas-estructuras-1}
...
\imagen{img/EstructurasClases2.png}{Imagen para ver estructuras de grupos teóricos cuando hay dos grupos}{fig:problemas-estructuras-2}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.55\textwidth]{img/EstructurasClases3.png}
	\caption{Imagen donde se aprecia otra estructura para los grupos prácticos}
	\label{fig:problemas-estructuras-3}
\end{figure}
...
Con el objetivo de que este proceso de carga funcione, se han de seguir las reglas añadidas en la penúltima hoja del Excel sobre la unificación que debe tener este archivo.
...
En la figura~\ref{fig:proceso-analizador} se explica en un esquema los pasos que sigue el analizador léxico una vez se manda el archivo para poder cargar las reservas periódicas en la base de datos.

\imagen{img/ProcesoAnalizador.png}{Imagen con los pasos para cargar los horarios en la base de datos}{fig:proceso-analizador}
...
Dividiéndose así, de forma clara las operaciones que puede realizar cada uno de los roles y las funcionalidades a las que puede acceder, adaptándose así a los diferentes tipos de perfiles que van a hacer uso de esta herramienta.

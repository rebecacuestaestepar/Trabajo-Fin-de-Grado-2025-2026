...
En esta sección de la memoria, se recogen los conceptos teóricos más relevantes para la comprensión del proyecto desarrollado.
...
\imagen{img/django_mvt_image_geeks_for_geeks.jpg}{Imagen patrón arquitectónico MVT~\cite{mvt:geek}}{fig:patron-mvt}

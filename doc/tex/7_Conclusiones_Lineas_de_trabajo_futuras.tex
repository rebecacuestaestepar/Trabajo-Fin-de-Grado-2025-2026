...
Además, también podría abordarse como mejora futura la obtención y configuración de un certificado SSL para la aplicación desplegada. Esto permitiría reforzar la seguridad de las comunicaciones entre cliente y servidor mediante el uso de conexiones cifradas, aportando una capa adicional de protección y alineando el sistema con buenas prácticas habituales en el despliegue de aplicaciones web.

...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-8}    & \textbf{Consultar calendario de exámenes}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Rebeca Cuesta Estépar \\
		\textbf{Requisitos asociados} &  \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-8 Consultar calendario de exámenes}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-9}    & \textbf{Consultar calendario académico}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Rebeca Cuesta Estépar \\
		\textbf{Requisitos asociados} &  \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-9 Consultar calendario académico}
\end{table}

...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-10}    & \textbf{Validar restricciones del horario}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Rebeca Cuesta Estépar \\
		\textbf{Requisitos asociados} &  \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-10 Validar restricciones del horario}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\begin{itemize}
			...
			\item \textbf{Ex2:} Campos obligatorios están incompletos \textrightarrow{} se muestra el mensajeS
		\end{itemize} \\
		\textbf{Importancia}          & Alta \\
		\bottomrule
	\end{tabularx}

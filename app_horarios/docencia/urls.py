...
from .views import CargarHorarioExcelView, ObtenerAsignaturasPorGradoYSemestreView, ObtenerCursosGradoView, ObtenerCursosView, ObtenerGradosView, ObtenerGruposAsignaturaView, ObtenerSemestresPorGradoView, SemestresPorGradoView
...
urlpatterns = [
    ...
    path('grados/<str:id_grado>/cursos/<str:curso_grado>/semestres/<str:semestre>/asignaturas/', ObtenerAsignaturasPorGradoYSemestreView.as_view(), name='obtener_asignaturas_por_grado_curso_semestre'),
